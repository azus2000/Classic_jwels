				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+123) 456 789" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+91) 12345 67890</a>
								</li>
							</ul>
						</div>
							...
							<ul>
                                ...
                                <?php if(Route::has('login')): ?>
									...
									<ul class="submenu curency" >
                                        ...
                                        <li class="menu-item" >
											<a title="Logout" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit(); ">Logout</a>
										</li>
									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt">Classic Jewellery, Bank More,Dhanbad, Jharkhand-826005, India</p>
											</li>
											<li>
												<i class="fa fa-phone" aria-hidden="true"></i>
												<p class="contact-txt">(+91) 12345 67890 </p>
											</li>
											<li>
												<i class="fa fa-envelope" aria-hidden="true"></i>
												<p class="contact-txt">Contact@classicjewelry.com</p>
											</li>											
										</ul>
									</div>
								</div>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-hotline-footer">
										...
										<b class="phone-number">(+91) 88888 99999 </b>
									</div>
								</div>
							</div>
...
</html><?php /**PATH C:\xampp\htdocs\Ecommerce-With-Laravel-8-and-Livewire-main\resources\views/layouts/base.blade.php ENDPATH**/ ?>